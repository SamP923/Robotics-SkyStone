 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Auto_Pumpkin: Drive LEFT to Red", group="Pumpkin: RED")
public class Auto_Pumpkin_DriveLEFTtoRED extends LinearOpMode{
